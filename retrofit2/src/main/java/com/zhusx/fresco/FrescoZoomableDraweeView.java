 ...
 * Created      2018/3/29 9:48
 */

public class FrescoZoomableDraweeView extends SimpleDraweeView {
    ...
    public FrescoZoomableDraweeView(Context context) {
        super(context);
        init();
    }

    public FrescoZoomableDraweeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public FrescoZoomableDraweeView(Context context, AttributeSet attrs, int defStyle) {
        ...
        GestureDetector.SimpleOnGestureListener gestureListener = new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onSingleTapConfirmed(MotionEvent e) {
                if (mClickListener != null) {
                    mClickListener.onClick(FrescoZoomableDraweeView.this);
                }
                return true;
            }
